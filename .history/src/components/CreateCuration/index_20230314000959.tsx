  ...
  return (
    <div className="w-full h-screen text-gray-900">
      <div className="w-full h-full pl-8 pt-8">
        ...
        <div className="flex h-3/4 justify-center mt-2 mb-4">
          <div className="w-1/2">
            <p className="font-bold">선택된 글</p>
            <div className="h-full h-fit w-4/5 border-solid border-black">글들..</div>
          </div>
        ...
        <div className="flex flex-row w-1/3 lg:h-[40px] justify-end">
          <button

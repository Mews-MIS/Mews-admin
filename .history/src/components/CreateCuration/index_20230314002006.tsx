    ...
    <div className="w-full h-screen text-gray-900">
      <div className="w-full h-full pl-8 pt-8">
        ...
        <div className="flex lg:h-[40px] justify-end pr-20">
          <button
            className="bg-gray-300 p-6 flex items-center text-sm font-medium rounded-lg text-white hover:bg-gray-400 mr-2 md:text-base lg:text-base"
            onClick={() => {
          ...
          <button
            className="text-sm font-medium p-6 rounded-lg text-white hover:bg-[#FFBD29] bg-[#FF9136] md:text-base lg:text-base"

  ...
  return (
    <div className="w-full h-screen text-gray-900">
      <div className="w-full h-full pl-8 pt-8">
        ...
        <div className="flex h-1/5 lg:h-[40px] justify-end">
          <button
            className="bg-gray-300 p-6 text-sm font-medium rounded-lg text-white hover:bg-gray-400 mr-8 md:text-base lg:text-base"
            onClick={() => {

  ...
  return (
    <div className="w-full h-screen text-gray-900">
      <div className="w-full h-full pl-8 pt-8">
        ...
        <div className="flex h-4/5 justify-center mt-2 mb-4">
          <div className="w-1/2">
        ...
        <div className="flex lg:h-[40px] justify-end pr-16">
          <button
            className="bg-gray-300 p-4 text-sm font-medium rounded-lg text-white hover:bg-gray-400 mr-8 md:text-base lg:text-base"
            onClick={() => {
          ...
          <button
            className="text-sm font-medium rounded-lg text-white hover:bg-[#FFBD29] bg-[#FF9136] md:text-base lg:text-base"
